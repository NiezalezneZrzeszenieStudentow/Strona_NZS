...
== Screenshots ==
1. Settings Page
2. Errorpage: Database
3. Errorpage: Cachefolder doesn't exist
4. Errorpage: Cachefolder has not the correct permissions
5. Errorpage: Cachefolder is not writeable
6. Errorpage: no Copyoption available
...
== Upgrade Notice ==
The current version of this Plugin requires WordPress 4.0 or higher. If you use older version of WordPress, you need to upgrade WordPress first.