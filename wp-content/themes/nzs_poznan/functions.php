...
if(!defined('fantazyjaPoznanska_THEME_URL')){
	define('fantazyjaPoznanska_THEME_URL',WP_CONTENT_URL.'/themes/'.get_template().'/');
}

require_once fantazyjaPoznanska_THEME_DIR.'/libs/utils.php';
require_once fantazyjaPoznanska_THEME_DIR.'/libs/post-type.php';

/**
 * nzs_poznan functions and definitions
 *
...
if ( ! function_exists( 'nzs_poznan_setup' ) ) :
	/**
	 ...
	 */
	function nzs_poznan_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on nzs_poznan, use a find and replace
		 * to change 'nzs_poznan' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'nzs_poznan', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'nzs_poznan_custom_background_args', array(
 ...
 */
function nzs_poznan_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'nzs_poznan_content_width', 640 );
}
add_action( 'after_setup_theme', 'nzs_poznan_content_width', 0 );
 ...
 */
function nzs_poznan_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'nzs_poznan' ),
		'id'            => 'sidebar-1',
		'description'   => 'Widgety w sidebarze',
 ...
 */
function nzs_poznan_scripts() {
	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'nzs_poznan_scripts' );
