...
function sydney_toolbox_register_employees() {
	...
	$labels = array(
		'name'                  => _x( 'Członkowie', 'Post Type General Name', 'sydney_toolbox' ),
		'singular_name'         => _x( 'Członkowie', 'Post Type Singular Name', 'sydney_toolbox' ),
		'menu_name'             => __( 'Członkowie', 'sydney_toolbox' ),
		'name_admin_bar'        => __( 'Członkowie', 'sydney_toolbox' ),
		'archives'              => __( 'Item Archives', 'sydney_toolbox' ),
		'parent_item_colon'     => __( 'Parent Item:', 'sydney_toolbox' ),
		'all_items'             => __( 'Wszyscy członkowie', 'sydney_toolbox' ),
		'add_new_item'          => __( 'Dodaj nowego członka', 'sydney_toolbox' ),
		'add_new'               => __( 'Dodaj nowego członka', 'sydney_toolbox' ),
		'new_item'              => __( 'Nowy członek', 'sydney_toolbox' ),
		'edit_item'             => __( 'EEdytuj członka', 'sydney_toolbox' ),
